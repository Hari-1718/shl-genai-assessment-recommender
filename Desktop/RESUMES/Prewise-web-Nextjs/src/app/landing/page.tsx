    ...
    <main className="flex-1 flex flex-col items-center w-full">
      <section className="w-full relative px-6 py-12 lg:py-24 flex justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-[960px] flex flex-col items-center text-center gap-6">
          ...
          <p className="text-slate-200 text-xl md:text-2xl max-w-5xl leading-relaxed text-center">
            <span className="font-bold whitespace-nowrap">Build Your Next Product Bet with On-Demand Product Leadership.</span>
            <span className="block text-base md:text-lg mt-1 opacity-90">Tell us who you are so we can collaborate in the right way.</span>
          </p>
