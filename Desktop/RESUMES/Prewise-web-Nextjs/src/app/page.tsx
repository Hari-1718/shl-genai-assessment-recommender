    ...
    <main className="flex-1 flex flex-col items-center w-full">
      <section className="w-full relative px-6 py-12 lg:py-24 flex justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-[960px] flex flex-col items-center text-center gap-8">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight leading-[1.1]" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
            <TextGenerateEffect
          ...
          <div className="flex flex-col gap-4 text-slate-300 text-lg md:text-lg max-w-2xl font-light leading-relaxed text-left">
            <p>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
            <Link
              ...
              className="h-12 px-8 rounded-lg bg-primary hover:bg-blue-600 text-white font-bold text-base transition-all duration-200 hover:shadow-xl hover:shadow-blue-900/30 flex items-center gap-2 transform hover:-translate-y-1 focus-ring"
            >
